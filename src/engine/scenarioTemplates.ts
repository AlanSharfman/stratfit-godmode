...
export const SCENARIO_TEMPLATES: ScenarioTemplate[] = [
  ...
  { id: "cut-to-profitability", question: "Cut burn to reach profitability", category: "capital", forces: { burn: -50_000, growth: -8, efficiency: 0.15 }, description: "Aggressive cost reduction for cash flow positive" },
  ...
  { id: "launch-marketplace", question: "Build an integration marketplace", category: "growth", forces: { burn: 20_000, growth: 8, churn: -2, efficiency: 0.05 }, description: "Platform ecosystem for stickiness and reach" },
  ...
  { id: "new-regulation", question: "New regulation requires compliance investment", category: "market", forces: { burn: 15_000, efficiency: -0.05 }, description: "Mandatory compliance spend" },
  ...
  { id: "cofounder-leaves", question: "Co-founder departs", category: "risk", forces: { efficiency: -0.15, growth: -5, burn: -10_000 }, description: "Leadership disruption" },
  ...
  { id: "cash-crunch", question: "Fundraising fails — extend runway with current cash", category: "risk", forces: { burn: -30_000, growth: -15, efficiency: 0.1 }, description: "Survival mode: cut everything non-essential" },
]
