...
const STAGE_BENCHMARKS: Record<CompanyStage, BenchmarkProfile> = {
  "pre-seed": {
    ...
    kpis: {
      ...
      nrr: { p25: 80, p50: 92, p75: 102, top10: 112 },
      efficiency: { p25: 0.25, p50: 0.5, p75: 0.8, top10: 1.2 },
  ...
  "seed": {
    ...
    kpis: {
      ...
      nrr: { p25: 85, p50: 95, p75: 105, top10: 115 },
      efficiency: { p25: 0.3, p50: 0.6, p75: 1.0, top10: 1.6 },
  ...
  "series-a": {
    ...
    kpis: {
      ...
      nrr: { p25: 88, p50: 98, p75: 110, top10: 122 },
      efficiency: { p25: 0.35, p50: 0.75, p75: 1.2, top10: 2.0 },
  ...
  "series-b": {
    ...
    kpis: {
      ...
      nrr: { p25: 90, p50: 102, p75: 115, top10: 130 },
      efficiency: { p25: 0.4, p50: 0.9, p75: 1.4, top10: 2.4 },
  ...
  "growth": {
    ...
    kpis: {
      ...
      nrr: { p25: 92, p50: 105, p75: 120, top10: 135 },
      efficiency: { p25: 0.45, p50: 1.0, p75: 1.6, top10: 2.8 },
...
const KPI_VALUE_MAP: Record<KpiKey, (k: any) => number> = {
  ...
  nrr: (k) => k.nrrPct ?? 0,
  efficiency: (k) => k.efficiencyRatio ?? 0,
