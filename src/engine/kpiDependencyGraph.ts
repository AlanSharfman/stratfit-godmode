...
const EDGES: KpiEdge[] = [
  ...
  { from: "growth",      to: "nrr",             weight:  0.4 },
  { from: "cash",        to: "runway",          weight:  0.9 },
  { from: "headcount",   to: "burn",            weight:  0.6 },
  { from: "headcount",   to: "efficiency",      weight: -0.5 },
  { from: "headcount",   to: "growth",          weight:  0.3 },
  { from: "nrr",         to: "arr",             weight:  0.5 },
  { from: "nrr",         to: "enterpriseValue", weight:  0.4 },
  { from: "nrr",         to: "revenue",         weight:  0.3 },
