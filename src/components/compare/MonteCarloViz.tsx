...
function SimulationBundle({ 
  ...
  return (
    <group ref={linesRef}>
      ...
      {/* Mean line (bold) */}
      <line>
        <primitive attach="geometry" object={meanPath} />
        <lineBasicMaterial 
          color={color} 
          transparent 
          opacity={opacity * 0.9}
      ...
      <line>
        <primitive attach="geometry" object={p5Path} />
        <lineBasicMaterial 
          color={color} 
          transparent 
          opacity={opacity * 0.4}
      ...
      {/* P95 line */}
      <line>
        <primitive attach="geometry" object={p95Path} />
        <lineBasicMaterial 
          color={color} 
          transparent 
          opacity={opacity * 0.4}
...
function AxisSystem() {
  ...
  return (
    <group>
      {/* Axes */}
      <line>
        <primitive attach="geometry" object={xAxisGeo} />
        <lineBasicMaterial color="#334155" />
      </line>
      <line>
        <primitive attach="geometry" object={yAxisGeo} />
        <lineBasicMaterial color="#334155" />
      </line>
