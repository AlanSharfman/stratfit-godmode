...
export const Moon: React.FC<MoonProps> = ({ rightOffset = 12, topOffset = 10, scale = 1 }) => {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 120 120" className="h-full w-full" style={{ overflow: "visible" }}>
        <defs>
        ...
        {/* Outer glow */}
        <circle cx="60" cy="60" r="55" fill="url(#moonGradient)" />
