// src/components/simulate/components/SensitivityBars.tsx
  ...
  return (
    <div className="sensitivity-bars">
      {displayFactors.map((factor, index) => {
        ...
        return (
          <div key={factor.lever} className={`sensitivity-row ${factor.direction}`}>
            {/* Rank indicator */}
            ...
            <div className="sensitivity-bar-container">
              ...
              <div className="sensitivity-negative-zone">
                {!isPositive && (
                  <div className="sensitivity-bar negative" style={{ width: `${barWidth}%` }}>
              ...
              <div className="sensitivity-positive-zone">
                {isPositive && (
                  <div className="sensitivity-bar positive" style={{ width: `${barWidth}%` }}>
                    <div className="bar-glow" />
                  </div>
                )}
              </div>
            ...
            {/* Category tag */}
            <div className={`sensitivity-category ${getCategoryClass(factor.lever)}`}>{getCategory(factor.lever)}</div>
          </div>
        );
      })}
