...
/**
 * P90Path — upper-bound corridor (90th percentile, flat ribbon).
 * Stable mesh ref: mesh created ONCE, geometry updated on data change.
 */
export default function P90Path({
    scenarioId = "baseline",
    visible = true,
}: {
    scenarioId?: string;
    ...
    // Derive P90 nodes by offsetting P50 y coordinate upward
    const nodes = useMemo(() => {
    ...
    useEffect(() => {
        ...
        console.log("[P90Path] Updating ribbon geometry (flat surface-following)");
